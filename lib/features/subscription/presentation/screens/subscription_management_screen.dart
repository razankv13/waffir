          ...
          children: [
            ...
            if (effectiveIsSubscribed)
              SingleChildScrollView(
                padding: responsive.sPadding(const EdgeInsets.only(top: 108, bottom: 40)),
                child: const Center(child: ManageSubscriptionView()),
              )
            else
              SingleChildScrollView(
                padding: responsive.sPadding(const EdgeInsets.only(top: 108, bottom: 160)),
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: responsive.s(13)),
                      const SubscriptionBenefitsSection(),
                      SizedBox(height: responsive.s(32)),
                      Container(
                        width: responsive.s(338),
                        height: 1,
            ...
            WaffirBackButton(onTap: () => context.pop(), size: responsive.s(44)),
            if (!effectiveIsSubscribed)
...
class _SubscriptionBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Positioned(
      top: responsive.s(-103.46),
      left: responsive.s(-40),
      child: Container(
        width: responsive.s(467.78),
        height: responsive.s(477.28),
        decoration: BoxDecoration(
